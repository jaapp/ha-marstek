...
from .const import DATA_COORDINATOR, DOMAIN, METHOD_BATTERY_STATUS, METHOD_ES_STATUS
from .coordinator import MarstekDataUpdateCoordinator, MarstekMultiDeviceCoordinator


def _command_stats_snapshot(coordinator: MarstekDataUpdateCoordinator) -> dict[str, Any]:
    api = coordinator.api
    es_stats = api.get_command_stats(METHOD_ES_STATUS)
    bat_stats = api.get_command_stats(METHOD_BATTERY_STATUS)
